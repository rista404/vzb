...
var __vueify_style__ = require("vueify-insert-css").insert(".Filter_Fakulteta h2 {\n  color: white;\n  font-weight: 400;\n  margin-bottom: 8px; }\n  .Filter_Fakulteta h2.head {\n    margin-top: 15px;\n    color: #21c3eb; }\n  .Filter_Fakulteta h2 a {\n    margin-down: 10px;\n    color: white; }\n\n.Filter_Fakulteta hr {\n  margin: 10px 0; }\n\n@media screen and (min-width: 768px) {\n  .Filter_Fakulteta .indent {\n    margin-left: 30px; } }\n")
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/rista/Projects/vzb/resources/assets/app/components/Filter_Fakulteta.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache[".Filter_Fakulteta h2 {\n  color: white;\n  font-weight: 400;\n  margin-bottom: 8px; }\n  .Filter_Fakulteta h2.head {\n    margin-top: 15px;\n    color: #21c3eb; }\n  .Filter_Fakulteta h2 a {\n    margin-down: 10px;\n    color: white; }\n\n.Filter_Fakulteta hr {\n  margin: 10px 0; }\n\n@media screen and (min-width: 768px) {\n  .Filter_Fakulteta .indent {\n    margin-left: 30px; } }\n"] = false
...
var __vueify_style__ = require("vueify-insert-css").insert(".Landing h1 {\n  font-weight: 300;\n  color: white; }\n")
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rista/Projects/vzb/resources/assets/app/components/Landing.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache[".Landing h1 {\n  font-weight: 300;\n  color: white; }\n"] = false
    document.head.removeChild(__vueify_style__)
  })
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div class=\"Profile\"><div class=\"Profile__Name\"><h3>Debeli Gmaz</h3></div><div class=\"Profile__Image\"><img src=\"http://www.radfaces.com/images/avatars/eddie-gelfen.png\"/></div></div>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rista/Projects/vzb/resources/assets/app/components/Profile.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache[".Profile .Profile__Name {\n  display: inline-block;\n  vertical-align: middle;\n  padding-right: 20px; }\n  .Profile .Profile__Name h3 {\n    font-size: 22px;\n    font-weight: 500;\n    line-height: 80px; }\n\n.Profile .Profile__Image {\n  display: inline-block;\n  vertical-align: middle; }\n  .Profile .Profile__Image img {\n    border: 2px solid #21c3eb;\n    border-radius: 21px;\n    width: 42px;\n    cursor: pointer; }\n"] = false
    document.head.removeChild(__vueify_style__)
  })
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div class=\"Tips\"><h1>Here goes tips</h1></div>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rista/Projects/vzb/resources/assets/app/components/Tips.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<header class=\"Top-Bar\"><div class=\"container\"><div class=\"col-xs-7\"><ul class=\"Top-Bar__Nav\"><li class=\"Top-Bar__Nav_Item\"><h3> <a href=\"#\">Info</a></h3></li><li class=\"Top-Bar__Nav_Item\"><h3> <a href=\"#\">Kontakt</a></h3></li><li class=\"Top-Bar__Nav_Item\"><h3> <a href=\"#\">Uputstvo</a></h3></li></ul></div><div class=\"col-xs-5 ta-right\"><profile></profile></div></div></header>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rista/Projects/vzb/resources/assets/app/components/Top_Bar.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache[".Top-Bar .Top-Bar__Nav .Top-Bar__Nav_Item {\n  display: inline-block;\n  padding-right: 20px; }\n  @media screen and (min-width: 768px) {\n    .Top-Bar .Top-Bar__Nav .Top-Bar__Nav_Item {\n      padding-right: 35px; } }\n  .Top-Bar .Top-Bar__Nav .Top-Bar__Nav_Item h3 {\n    line-height: 80px;\n    font-weight: 400;\n    font-size: 20px; }\n    .Top-Bar .Top-Bar__Nav .Top-Bar__Nav_Item h3 a, .Top-Bar .Top-Bar__Nav .Top-Bar__Nav_Item h3 a:hover {\n      color: #333; }\n"] = false
    document.head.removeChild(__vueify_style__)
  })
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div class=\"Domovi\"><h1>Here goes Domovi</h1></div>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rista/Projects/vzb/resources/assets/app/views/Domovi.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div class=\"Fakultet fadeInDown\"><a href=\"#!/fakulteti\"><img src=\"/img/left.png\"/></a><h1 class=\"heading\">{{ res.nazivu }}</h1><a href=\"#!/fakulteti\" class=\"close\"><img src=\"/img/close.png\"/></a><hr/><div class=\"row\"><div class=\"Tab col-xs-3\"><h2 @click=\"currentTab = 1\" v-bind:class=\"{ 'active':  currentTab == 1}\">SMEROVI</h2></div><div class=\"Tab col-xs-3\"><h2 @click=\"currentTab = 2\" v-bind:class=\"{ 'active':  currentTab == 2}\">LOKACIJA</h2></div><div class=\"Tab col-xs-3\"><h2 @click=\"currentTab = 3\" v-bind:class=\"{ 'active':  currentTab == 3}\">KONTAKT</h2></div><div class=\"Tab col-xs-3\"><h2 @click=\"currentTab = 4\" v-bind:class=\"{ 'active':  currentTab == 4}\">GALERIJA</h2></div></div><div class=\"Info row\"><div v-show=\"currentTab == 1\" class=\"Smerovi col-sm-12 fadeInDown\"><list :list=\"res.study_programs\"></list></div><div v-show=\"currentTab == 2\" class=\"col-sm-12 fadeInDown\"><div class=\"row\"><div class=\"col-xs-12\"><div id=\"map\"><h1>To be done!</h1></div></div></div></div><div v-show=\"currentTab == 3\" class=\"Kontakt col-sm-12 fadeInDown\"><div class=\"row\"><div class=\"col-xs-12\"><h2>Email: {{ res.email }}</h2><h2>Broj Telefona: {{ res.tel }}</h2><h2>Website: <a href=\"{{ res.www }}\">{{ res.www }}</a></h2></div></div></div><div v-show=\"currentTab == 4\" class=\"col-sm-12 fadeInDown\"><h1>To be done!</h1></div></div></div>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
var _Top_Bar = require('../components/Top_Bar.vue');

var _Top_Bar2 = _interopRequireDefault(_Top_Bar);

var _Side_Menu = require('../components/Side_Menu.vue');
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div class=\"Menze\"><h1>Here goes Menze</h1></div>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rista/Projects/vzb/resources/assets/app/views/Menze.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "<div class=\"Zanimljivosti\"><h1>Here goes Zanimljivost</h1></div>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/rista/Projects/vzb/resources/assets/app/views/Zanimljivosti.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, module.exports.template)
